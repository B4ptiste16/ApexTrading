...
# AI provider / model loaded from .env (AI_PROVIDER, AI_MODEL, GOOGLE_AI_API_KEY …)
# Falls back to Anthropic / claude-haiku if not configured.
MAX_TOKENS             = 800
...
def get_sleep_seconds() -> int:
    ...
    try:
        ...
        return _D.resolve_call_delay("LONG")
    except Exception:
        pass
