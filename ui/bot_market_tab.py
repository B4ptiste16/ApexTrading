...
Layout:
  ...
  │  Browse, install and publish bots from the BAPTOU network. │
  ├──────────────────────────────────────────────────────────┤
...
from PyQt6.QtWidgets import (
    ...
    QFrame, QLineEdit, QSpinBox, QDoubleSpinBox, QMessageBox,
...
class BotMarketTab(QWidget):
    ...
    def _build(self):
        ...
        self._filt_philosophy = NoScrollComboBox()
        ...
        self._filt_sort = NoScrollComboBox()
    ...
    def _on_results_loaded(self, ok: bool, body: dict):
        ...
        if not bots:
            empties = {
                ...
                "mine":        "You haven't published any bots yet. Click ⬆ Publish a bot above to share one with the BAPTOU community.",
            }
